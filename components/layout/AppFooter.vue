    ...
    <div class="max-w-7xl mx-auto px-6 md:px-12 pt-12 pb-0">
      ...
      <div class="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-5 pb-16">
        ...
        <div>
          ...
          <ul class="space-y-3">
            <li><a href="/#services" class="font-sans text-sm text-text-muted hover:text-white transition-colors">What we offer</a></li>
            <li><a href="/#catalog"  class="font-sans text-sm text-text-muted hover:text-white transition-colors">Catalog</a></li>
            <li><a href="/#commands" class="font-sans text-sm text-text-muted hover:text-white transition-colors">Commands</a></li>
          </ul>
        </div>
